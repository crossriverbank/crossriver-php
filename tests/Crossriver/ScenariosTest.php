<?php
namespace Crossriver\Tests;


use Crossriver\Settings;
use Crossriver\Tests\Fixtures;
use Crossriver\Resources\User;
...
use Crossriver\Resources\Dispute;
use Crossriver\Resources\Evidence;
use Crossriver\Resources\Webhook;
use Crossriver\Resources\Verification;
use Crossriver\Resources\Settlement;
use Crossriver\Resources\Reversal;
use Crossriver\Resources\Processor;
use Crossriver\Resources\Merchant;
use Crossriver\Resources\InstrumentUpdate;
...
class ScenariosTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        Settings::configure(["username" => ENV['CROSSRIVERBANK_ADMIN_USERNAME'], "password" => ENV['CROSSRIVERBANK_ADMIN_USERNAME']]);
